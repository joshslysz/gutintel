...
async def main():
    if len(sys.argv) != 2:
        print("Usage: python import_top_100_fixed.py <csv_file>")
        print("Example: python import_top_100_fixed.py gut_health_ingredients.txt")
        sys.exit(1)
    ...
    print("🧬 GUTINTEL TOP 85 IMPORT (FIXED VERSION)")
    print("=" * 50)
    
    importer = Top100ImporterFixed()
